...
func (urs *TenantUserRoleService) CreateUserRole(req *requests.UserRoleListReq) (bool, *[]models.SgrTenantUserRole) {
...
func (urs *TenantUserRoleService) QueryUserRole(req requests.UserRoleReq) (error, *page.Page) {
	var resData = &[]responses.UserRoleRes{}
...
func (urs *TenantUserRoleService) AllRoles() ([]responses.UserRoleRes, error) {
	var resData []responses.UserRoleRes
