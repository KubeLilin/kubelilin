...
func TestGetJenkinsJob(t *testing.T) {
	...
	builder.UseJenkins("http://jenkins:32001", "jenkins", "xxxxcd6150bd626d8ed73c3bfa02d6").
...
//
//	builder := pipelineV1.NewBuilder()
//	builder.UseJenkins("http://jenkins.sgr-ci:32001", "jenkins", "xxxxxcd6150bd626d8ed73c3bfa02d6").
//		UseKubernetes("sgr-ci").UseBuildImage("golang:1.16.5")
//
//	pipeline, _ := builder.Build()
//
...
//			{Key: "SGR_REGISTRY_AUTH", Value: "exxxx2Z4OnpsMTI1MzMwMw=="},
...
func TestParsePipelineJob(t *testing.T) {
	...
	builder := pipelineV1.NewBuilder()
	builder.UseJenkins("http://jenkins:32001", "jenkins", "xxxxxx50bd626d8ed73c3bfa02d6").
